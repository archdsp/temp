...
static char device_id[MAX_UUID_LEN] = "100c3bcfb6e04fe1b2efd6ed23229cf8";
static char token[MAX_UUID_LEN] = "91654f19dde44821bf36d832daffb06c";
static char pub_msg[MAX_MSG_LEN] = "{\"test_data_send\" : \"true\"}";
...
int main(int argc, char *argv[])
{
	...
	/*
	 * MQTT Qos는 3단계 제공
	 * 0 : 메시지는 한번만 전달, 전달 여부 미확인 (Fire and Forget)
	 * 1 : 메시지는 한번 이상 전달, 핸드세이킹 엄밀 추적(중복 전송 가능 있음)
	 * 2 : 메시는 한번만 전달, 핸드세이킹 과정 추적 (높은 품질, 성능 감소)
	 * 3 : 최대 한번, Fire and Forget
	 * 4 : Reserved
	 * */
	subscribe_msg.qos = 0;
